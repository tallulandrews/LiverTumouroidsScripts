...
Laura_Markers <- list(Chol=c("NDRG1", "DAPK1", "CA9"), Hep=c("AFM", "CYP27A1"), Stem=c("EXOSC9", "HMGB2", "HMMR"))
...
for (i in 1:length(clustered_rds)) {
	...
	saveRDS(SCE, file=paste(rds_names[i], "PlottingObj_Alt.rds", sep="_"))
}
...
saveRDS(STUFF , file="All_Plotting_stuff_Alt.rds")
...
png("Figure2_CCA1_MegaViolin_Alt.png", width=8.5*1.7, height=6, units="in", res=300)
graphics::layout(rbind(c(1,2,3,5), c(1,2,4,6)), 
		widths=c(1, 3, 1.5, 1.5), 
		heights=c(1.5, 1.5, 1.5 ))
Mega_plots("CCA1")
dev.off()
png("Figure2_HCC10_MegaViolin_Alt.png", width=8.5*1.7, height=6, units="in", res=300)
graphics::layout(rbind(c(1,2,3,5), c(1,2,4,6)), 
		widths=c(1, 3, 1.5, 1.5), 
		heights=c(1.5, 1.5, 1.5 ))
Mega_plots("HCC10")
...
png("Figure2S_CCA5_MegaViolin_Alt.png", width=8.5*1.7, height=6, units="in", res=300)
graphics::layout(rbind(c(1,2,3,5), c(1,2,4,6)), 
		widths=c(1, 3, 1.5, 1.5), 
		heights=c(1.5, 1.5, 1.5 ))
Mega_plots("CCA5")
dev.off()
png("Figure2S_HCC6_MegaViolin_Alt.png", width=8.5*1.7, height=6, units="in", res=300)
graphics::layout(rbind(c(1,2,3,5), c(1,2,4,6)), 
		widths=c(1, 3, 1.5, 1.5), 
		heights=c(1.5, 1.5, 1.5 ))
Mega_plots("HCC6")
dev.off()
png("Figure2S_HCC23_MegaViolin_Alt.png", width=8.5*1.7, height=6, units="in", res=300)
graphics::layout(rbind(c(1,2,3,5), c(1,2,4,6)), 
		widths=c(1, 3, 1.5, 1.5), 
		heights=c(1.5, 1.5, 1.5 ))
Mega_plots("HCC23")
dev.off()
png("Figure2S_HCC24_MegaViolin_Alt.png", width=8.5*1.7, height=6, units="in", res=300)
graphics::layout(rbind(c(1,2,3,5), c(1,2,4,6)), 
		widths=c(1, 3, 1.5, 1.5), 
		heights=c(1.5, 1.5, 1.5 ))
Mega_plots("HCC24")
dev.off()
png("Figure2S_D3DM_MegaViolin_Alt.png", width=8.5*1.7, height=6, units="in", res=300)
graphics::layout(rbind(c(1,2,3,5), c(1,2,4,6)), 
		widths=c(1, 3, 1.5, 1.5), 
		heights=c(1.5, 1.5, 1.5 ))
Mega_plots("D3DM")
dev.off()
png("Figure2S_D3EM_MegaViolin_Alt.png", width=8.5*1.7, height=6, units="in", res=300)
graphics::layout(rbind(c(1,2,3,5), c(1,2,4,6)), 
		widths=c(1, 3, 1.5, 1.5), 
		heights=c(1.5, 1.5, 1.5 ))
Mega_plots("D3EM")
dev.off()
png("Figure2S_D9DM_MegaViolin_Alt.png", width=8.5*1.7, height=6, units="in", res=300)
graphics::layout(rbind(c(1,2,3,5), c(1,2,4,6)), 
		widths=c(1, 3, 1.5, 1.5), 
		heights=c(1.5, 1.5, 1.5 ))
Mega_plots("D9DM")
dev.off()
png("Figure2S_D9EM_MegaViolin_Alt.png", width=8.5*1.7, height=6, units="in", res=300)
graphics::layout(rbind(c(1,2,3,5), c(1,2,4,6)), 
		widths=c(1, 3, 1.5, 1.5), 
		heights=c(1.5, 1.5, 1.5 ))
Mega_plots("D9EM")
...
png("Figure2_CCA1_Mega_Alt.png", width=8.5*1.7, height=6, units="in", res=300)
graphics::layout(rbind(c(1,2,3,5,7), c(1,2,4,6,8)), 
		widths=c(1, 3, 1.5, 1.5, 1.5), 
		heights=c(1.5, 1.5, 1.5, 1.5))
Mega_plots("CCA1")
...
png("Figure2_HCC10_Mega_Alt.png", width=8.5*1.7, height=6, units="in", res=300)
graphics::layout(rbind(c(1,2,3,5,7), c(1,2,4,6,8)), 
		widths=c(1, 3, 1.5, 1.5, 1.5), 
		heights=c(1.5, 1.5, 1.5, 1.5))
Mega_plots("HCC10")
...
png("Figure2_HCC6_Mega_Alt.png", width=8.5*1.7, height=6, units="in", res=300)
graphics::layout(rbind(c(1,2,3,5,7), c(1,2,4,6,8)), 
		widths=c(1, 3, 1.5, 1.5, 1.5), 
		heights=c(1.5, 1.5, 1.5, 1.5))
Mega_plots("HCC6")
...
png("Figure2_HCC23_Mega_Alt.png", width=8.5*1.7, height=6, units="in", res=300)
graphics::layout(rbind(c(1,2,3,5,7), c(1,2,4,6,8)), 
		widths=c(1, 3, 1.5, 1.5, 1.5), 
		heights=c(1.5, 1.5, 1.5, 1.5))
Mega_plots("HCC23")
...
png("Figure2_HCC24_Mega_Alt.png", width=8.5*1.7, height=6, units="in", res=300)
graphics::layout(rbind(c(1,2,3,5,7), c(1,2,4,6,8)), 
		widths=c(1, 3, 1.5, 1.5, 1.5), 
		heights=c(1.5, 1.5, 1.5, 1.5))
Mega_plots("HCC24")
...
png("Figure2_CCA5_Mega_Alt.png", width=8.5*1.7, height=6, units="in", res=300)
graphics::layout(rbind(c(1,2,3,5,7), c(1,2,4,6,8)), 
		widths=c(1, 3, 1.5, 1.5, 1.5), 
		heights=c(1.5, 1.5, 1.5, 1.5))
Mega_plots("CCA5")
