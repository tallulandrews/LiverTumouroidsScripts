...
# Donor3
24906_6_to_bam.out : 
	bsub -J"24906_6_to_bam[1-384]%30" -R"select[mem>1000] rusage[mem=1000]" -M1000 -o 24906_6_to_bam.%J.%I.run /nfs/users/nfs_t/ta6/RNASeqPipeline/0_Flexible_Convert_Dir_CRAM_to_BAM.sh /warehouse/team218_wh01/tallulah/Meritxell_Gurdon/Laura/scRNASeqTumouroidsExp2/Run24906Lane6 /lustre/scratch117/cellgen/team218/TA/LiverOrganoids/BAMS
	bsub -o 24906_6_to_bam.special.run -R"select[mem>1000] rusage[mem=1000]" -M1000 /nfs/users/nfs_t/ta6/RNASeqPipeline/0_Flexible_Convert_Dir_CRAM_to_BAM.sh /warehouse/team218_wh01/tallulah/Meritxell_Gurdon/Laura/scRNASeqTumouroidsExp2/Run24906Lane6 /lustre/scratch117/cellgen/team218/TA/LiverOrganoids/BAMS 0
	echo "Done" > $@

24906_7_to_bam.out : 
	bsub -J"24906_7_to_bam[1-384]%30" -R"select[mem>1000] rusage[mem=1000]" -M1000 -o 24906_7_to_bam.%J.%I.run /nfs/users/nfs_t/ta6/RNASeqPipeline/0_Flexible_Convert_Dir_CRAM_to_BAM.sh /warehouse/team218_wh01/tallulah/Meritxell_Gurdon/Laura/scRNASeqTumouroidsExp2/Run24906Lane7 /lustre/scratch117/cellgen/team218/TA/LiverOrganoids/BAMS
	echo "Done" > $@

# Donor9
25078_3_to_bam.out : 
	bsub -J"25078_3_to_bam[1-384]%30" -R"select[mem>1000] rusage[mem=1000]" -M1000 -o 25078_3_to_bam.%J.%I.run /nfs/users/nfs_t/ta6/RNASeqPipeline/0_Flexible_Convert_Dir_CRAM_to_BAM.sh /warehouse/team218_wh01/tallulah/Meritxell_Gurdon/Laura/scRNASeqTumouroidsExp2/Run25078Lane3 /lustre/scratch117/cellgen/team218/TA/LiverOrganoids/BAMS
	echo "Done" > $@

25014_6_to_bam.out : 
	bsub -J"25014_6_to_bam[1-384]%30" -R"select[mem>1000] rusage[mem=1000]" -M1000 -o 25014_6_to_bam.%J.%I.run /nfs/users/nfs_t/ta6/RNASeqPipeline/0_Flexible_Convert_Dir_CRAM_to_BAM.sh /warehouse/team218_wh01/tallulah/Meritxell_Gurdon/Laura/scRNASeqTumouroidsExp2/Run25014Lane6 /lustre/scratch117/cellgen/team218/TA/LiverOrganoids/BAMS
	echo "Done" > $@

# Second Trio
25078_2_to_bam.out : 
	bsub -J"25078_2_to_bam[1-384]%30" -R"select[mem>1000] rusage[mem=1000]" -M1000 -o 25078_2_to_bam.%J.%I.run /nfs/users/nfs_t/ta6/RNASeqPipeline/0_Flexible_Convert_Dir_CRAM_to_BAM.sh /warehouse/team218_wh01/tallulah/Meritxell_Gurdon/Laura/scRNASeqTumouroidsExp2/Run25078Lane2 /lustre/scratch117/cellgen/team218/TA/LiverOrganoids/BAMS
	echo "Done" > $@

24905_8_to_bam.out : 
	bsub -J"24905_8_to_bam[1-384]%30" -R"select[mem>1000] rusage[mem=1000]" -M1000 -o 24905_8_to_bam.%J.%I.run /nfs/users/nfs_t/ta6/RNASeqPipeline/0_Flexible_Convert_Dir_CRAM_to_BAM.sh /warehouse/team218_wh01/tallulah/Meritxell_Gurdon/Laura/scRNASeqTumouroidsExp2/Run24905Lane8 /lustre/scratch117/cellgen/team218/TA/LiverOrganoids/BAMS
	echo "Done" > $@

25014_5_to_bam.out : 
	bsub -J"25014_5_to_bam[1-384]%30" -R"select[mem>1000] rusage[mem=1000]" -M1000 -o 25014_5_to_bam.%J.%I.run /nfs/users/nfs_t/ta6/RNASeqPipeline/0_Flexible_Convert_Dir_CRAM_to_BAM.sh /warehouse/team218_wh01/tallulah/Meritxell_Gurdon/Laura/scRNASeqTumouroidsExp2/Run25014Lane5 /lustre/scratch117/cellgen/team218/TA/LiverOrganoids/BAMS
	echo "Done" > $@
